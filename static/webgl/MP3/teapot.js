...
function loadTeapotModel() {
  $.get('teapot_0.obj', function(data) {
    teapot = createModel(ComputeNorms(LoadObj(data)));
  });
  return teapot;
}
...
function createModel(modelData) {  // For creating the teapot model.
    var model = {};
    ...
    console.log("Teapot vertexPositions length: " + (1202));
    ...
    console.log("Teapot vertexNormals length: " + (1202));
    ...
    console.log("Teapot TextureCoords length: " + (1202));
    ...
    console.log("Teapot Indices length: " + (6768));
...
function uploadLightsToShader(loc,a,d,s) {
 ...
 function draw() {
    ...
    //uploadMaterialToShader([0.5,0.0,0.0],[0.204,0.0,0.0],[1.0,1.0,1.0],64);
